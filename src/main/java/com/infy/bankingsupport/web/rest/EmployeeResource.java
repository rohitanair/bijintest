...
import com.infy.bankingsupport.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.infy.bankingsupport.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "*", allowedHeaders = "*") public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "bijintestEmployee";
